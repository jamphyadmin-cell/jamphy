    ...
    return (
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-xl border border-zinc-700 hover:bg-zinc-800 transition text-sm font-medium text-white"
        >
          Login with
      ...
      >
        {session.user?.image ? (
          <Image
            ...
            width={38}
            height={38}
            className="rounded-full border-2 border-transparent hover:border-zinc-600 transition-all cursor-pointer"
          />
        ) : (
